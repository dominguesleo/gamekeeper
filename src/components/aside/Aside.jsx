      ...
      <div className='aside-mobile'>
            <nav>
                ...
                <ul className="slide">
                    ...
                    <li><Link href="/top/best-of-the-year">Best of the year</Link></li>
                    <li><Link href="/top/popular-in-2023">Popular in 2023</Link></li>
                    <li><Link href="/top/all-time-top">All time top 250</Link></li>
