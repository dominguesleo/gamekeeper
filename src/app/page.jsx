...
async function getGames(page, retries = 5) {
    try {
        const response = await fetch(`https://api.rawg.io/api/games?page=${page}&page_size=80&key=a359d27af5fc427c87fb3af6dd0b91b4`);
        if (!response.ok) {
